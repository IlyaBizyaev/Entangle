...
#### BUILDING ####
	...
	$(CC) $(CFLAGS) ./src/EntangleFrame.cpp -o EntangleFrame.o
...
# WINDOWS BUILD
	...
	$(CC) -L$(WXDIR)\lib\gcc_lib -o Entangle.exe EntangleMain.o EntangleApp.o EntangleFrame.o EntangleExtras.o resource.res -s -static-libgcc -static-libstdc++ -mthreads $(LIBS) $(CRYPTDIR)cryptopp\libcryptopp.a -mwindows
else
# LINUX BUILD
	$(CC) -o Entangle EntangleMain.o EntangleApp.o EntangleFrame.o EntangleExtras.o -s -pthread -lwx_gtk2u_core-3.0 -lwx_baseu-3.0  -lwx_gtk2u_adv-3.0 -lcryptopp
endif
